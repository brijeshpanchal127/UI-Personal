...
import { selectCurrentFunction, selectStore } from "../../../../reducers/actions/landing.action";
...
export default function SideBar() {
  ...
  const displayProfileName = useSelector(state => state.display.displayProfile);
  var currentDisplayProfile = data.DISPLAY_PROFILE.find(o => o.name === displayProfileName);
  ...
  return (
    <List
      ...
      subheader={
        <ListSubheader component="div" id="nested-list-subheader">QPOS</ListSubheader>
      }
      className={classes.root}
    >
      {/* {
        storesData.storeProfile[currentStoreFunction]?.map(sidebarItem => (<ListItem button >
          <ListItemIcon>
            {sidebarItem.type === 'promos' ? <CardGiftcardIcon /> : <ExitToAppIcon />}
          </ListItemIcon>
      ...
      {/* Shortcuts */}
      <div className={ currentDisplayProfile.sideBarFunctionalities.includes("SHORTCUTS") ? '' : 'hidden'}>
      ...
      {/* Promos */}
      <div className={ currentDisplayProfile.sideBarFunctionalities.includes("PROMOS") ? '' : 'hidden'}>
